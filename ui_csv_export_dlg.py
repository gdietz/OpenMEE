...
#
# Created: Fri Jan 10 15:33:13 2014
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.horizontalLayout_2.addWidget(self.quote_text_cells_chkbox)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "This tool exports your current datasheet as a *.csv file.", None))
        self.excel_dialect_chkbox.setText(_translate("Dialog", "Apply Microsoft Excel friendly formatting?", None))
        self.quote_text_cells_chkbox.setText(_translate("Dialog", "Use quotations to fromat text?", None))
        ...
        self.delimter_lbl.setText(_translate("Dialog", "Column delimiter: ", None))
