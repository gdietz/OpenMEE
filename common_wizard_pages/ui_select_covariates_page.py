...
#
# Created: Tue Mar 25 15:49:46 2014
...
class Ui_WizardPage(object):
    def setupUi(self, WizardPage):
        ...
        self.unavailable_covs_groupbox = QtGui.QGroupBox(WizardPage)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.unavailable_covs_groupbox.sizePolicy().hasHeightForWidth())
        self.unavailable_covs_groupbox.setSizePolicy(sizePolicy)
        self.unavailable_covs_groupbox.setMinimumSize(QtCore.QSize(0, 0))
        self.unavailable_covs_groupbox.setBaseSize(QtCore.QSize(0, 0))
        self.unavailable_covs_groupbox.setObjectName(_fromUtf8("unavailable_covs_groupbox"))
        self.verticalLayout = QtGui.QVBoxLayout(self.unavailable_covs_groupbox)
        self.verticalLayout.setObjectName(_fromUtf8("verticalLayout"))
        self.unavailable_covs_listWidget = QtGui.QListWidget(self.unavailable_covs_groupbox)
        ...
        self.label = QtGui.QLabel(self.unavailable_covs_groupbox)
        self.label.setWordWrap(True)
        self.label.setObjectName(_fromUtf8("label"))
        self.verticalLayout.addWidget(self.label)
        self.gridLayout.addWidget(self.unavailable_covs_groupbox, 1, 0, 1, 1)
    ...
    def retranslateUi(self, WizardPage):
        ...
        self.unavailable_covs_groupbox.setTitle(_translate("WizardPage", "Unavailable Covariates", None))
