...
#
# Created: Thu Aug 22 11:37:08 2013
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/function_icon_set/images/function_icon_set/add_48.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionNew.setIcon(icon)
        self.actionNew.setObjectName(_fromUtf8("actionNew"))
        self.actionOpen = QtGui.QAction(MainWindow)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/function_icon_set/images/function_icon_set/folder_48.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOpen.setIcon(icon1)
        self.actionOpen.setObjectName(_fromUtf8("actionOpen"))
        self.actionSave = QtGui.QAction(MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/function_icon_set/images/function_icon_set/floppy_disk_48.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionImportCSV2 = QtGui.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/function_icon_set/images/function_icon_set/box_download_48.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionImportCSV2.setIcon(icon3)
        self.actionImportCSV2.setObjectName(_fromUtf8("actionImportCSV2"))
        ...
        self.actionExportCSV2 = QtGui.QAction(MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/function_icon_set/images/function_icon_set/box_upload_48.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionExportCSV2.setIcon(icon4)
        self.actionExportCSV2.setObjectName(_fromUtf8("actionExportCSV2"))
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/analysis_icons/images/calculate_effect_size.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCalculate_Effect_Size.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/analysis_icons/images/meta_analysis.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionStandard_Meta_Analysis.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/analysis_icons/images/cum_meta_analysis.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCumulative.setIcon(icon7)
        self.actionCumulative.setObjectName(_fromUtf8("actionCumulative"))
        self.actionLeave_one_out = QtGui.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/analysis_icons/images/leave_one_out.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionLeave_one_out.setIcon(icon8)
        self.actionLeave_one_out.setObjectName(_fromUtf8("actionLeave_one_out"))
        self.actionSubgroup = QtGui.QAction(MainWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8(":/analysis_icons/images/subgroup_ma.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSubgroup.setIcon(icon9)
        self.actionSubgroup.setObjectName(_fromUtf8("actionSubgroup"))
        self.actionMeta_Regression = QtGui.QAction(MainWindow)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8(":/analysis_icons/images/meta_reg.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionMeta_Regression.setIcon(icon10)
        ...
        self.toolBar.addAction(self.actionImportCSV2)
        self.toolBar.addAction(self.actionExportCSV2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionImportCSV2.setText(_translate("MainWindow", "CSV", None))
        self.actionImportCSV2.setToolTip(_translate("MainWindow", "import CSV", None))
        ...
        self.actionExportCSV2.setText(_translate("MainWindow", "As CSV", None))
        self.actionExportCSV2.setToolTip(_translate("MainWindow", "Export CSV", None))
