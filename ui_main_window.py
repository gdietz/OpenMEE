...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/analysis_icons/images/calculate_effect_size.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCalculate_Effect_Size.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/analysis_icons/images/meta_analysis.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionStandard_Meta_Analysis.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/analysis_icons/images/cum_meta_analysis.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCumulative.setIcon(icon5)
        self.actionCumulative.setObjectName(_fromUtf8("actionCumulative"))
        self.actionLeave_one_out = QtGui.QAction(MainWindow)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/analysis_icons/images/leave_one_out.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionLeave_one_out.setIcon(icon6)
        self.actionLeave_one_out.setObjectName(_fromUtf8("actionLeave_one_out"))
        self.actionSubgroup = QtGui.QAction(MainWindow)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/analysis_icons/images/subgroup_ma.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSubgroup.setIcon(icon7)
        self.actionSubgroup.setObjectName(_fromUtf8("actionSubgroup"))
        self.actionMeta_Regression = QtGui.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/analysis_icons/images/meta_reg.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionMeta_Regression.setIcon(icon8)
        self.actionMeta_Regression.setObjectName(_fromUtf8("actionMeta_Regression"))
        self.actionImportCSV = QtGui.QAction(MainWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8(":/function_icon_set/images/function_icon_set/box_download_48.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionImportCSV.setIcon(icon9)
