...
context("Cumulative Meta-Analysis")
...
test_that("Cumulative Meta-Analysis Runs", {
  results <- cum.ma.continuous(fname, tmp_obj, params)

  image.path <- results$images[["Cumulative Forest Plot"]]
...
# search replace:
# FIND: structure\(1L, .Label = (".*"), class = "factor"\),
# replace: $1,
