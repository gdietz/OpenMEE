...
context("Leave-one-out Meta-Analysis")
...
test_that("Leave-one-out Meta-Analysis Runs", {
  set.global.conf.level(95)
  results <- loo.ma.continuous(fname, tmp_obj, params)

  image.path <- results$images[['Leave-one-out Forest Plot']]
