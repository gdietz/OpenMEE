...
def get_covs_from_names(cov_names, model):
    '''
    Returns a list of covariate objects from the model that have the given
    names
    '''
...
class TestStandardMetaAnalysis(unittest.TestCase):
    ...
    def test_binaryMetaAnalysis(self):
        ...
        params = {
            'conf.level': 95.0,
            'digits': 3, 'fp_col2_str': u'[default]',
            'fp_show_col4': True,
            'to': 'only0',
    ...
    def test_continuousMetaAnalysis(self):
        ...
        data_location = {
            'experimental_mean': 2,
            'effect_size': 18,
            'experimental_std_dev': 5,
            'experimental_sample_size': 1,
            'control_std_dev': 5,
...
class TestMetaMethods(unittest.TestCase):
    ...
    def test_subgroup(self):
        ...
        covs_to_include = get_covs_from_names(
            cov_names_to_include,
            model=self.model,
        )
    ...
    def test_bootstrapped_ma(self):
        ...
        current_param_vals = {
            ...
            'measure': 'SMD',
            'fp_plot_lb': '[default]',
            'bootstrap.plot.path': '/Users/george/git/OpenMEE/r_tmp/bootstrap.png',
            'digits': 3,
            'fp_col2_str': u'[default]',
            'num.bootstrap.replicates': 1000,
            'fp_col4_str': u'Ev/Ctrl',
...
class TestMetaRegressionMethods(unittest.TestCase):
    def setUp(self):
        ...
        self.cov_ref_values = get_cov_ref_values_from_names_to_refvals(
            cov_names_to_ref_vals,
            model=self.model,
        )
        self.interactions = []
