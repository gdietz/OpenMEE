...
#
# Created: Fri Jan 10 15:09:22 2014
...
class Ui_CSVImportDialog(object):
    def setupUi(self, CSVImportDialog):
        ...
        self.delimter_le.setMaximumSize(QtCore.QSize(50, 20))
    ...
    def retranslateUi(self, CSVImportDialog):
        CSVImportDialog.setWindowTitle(_translate("CSVImportDialog", "Import a CSV", None))
        self.instructions.setText(_translate("CSVImportDialog", "Please select a csv file to import.", None))
        self.label.setText(_translate("CSVImportDialog", "This window lets you determine the delimeters in your *.csv file. The sub-window below provides a preview of the imported data based on your selection in the \"Import Options\" box.", None))
        self.groupBox.setTitle(_translate("CSVImportDialog", "Import Options", None))
        self.from_excel_chkbx.setText(_translate("CSVImportDialog", "Was this *.csv file exported/saved from Microsoft Excel?", None))
        self.has_headers_chkbx.setText(_translate("CSVImportDialog", "Are the columns labeled? (i.e. first row has text?)", None))
        ...
        self.missing_data_lbl.setText(_translate("CSVImportDialog", "Missing data are marked by:", None))
        self.delimter_lbl.setText(_translate("CSVImportDialog", "Column delimiter:", None))
        self.quotelbl.setText(_translate("CSVImportDialog", "Quote Character:", None))
        self.label_2.setText(_translate("CSVImportDialog", "For example: a space or comma", None))
        self.label_3.setText(_translate("CSVImportDialog", "This is important if some of your data contains spaces.", None))
        self.label_4.setText(_translate("CSVImportDialog", "For example, in R this is NA", None))
