...
#
# Created: Wed Jan  8 15:30:15 2014
...
class Ui_WizardPage(object):
    def setupUi(self, WizardPage):
        ...
        self.hist_colors_groupbox = QtGui.QGroupBox(WizardPage)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.hist_colors_groupbox.sizePolicy().hasHeightForWidth())
        self.hist_colors_groupbox.setSizePolicy(sizePolicy)
        self.hist_colors_groupbox.setObjectName(_fromUtf8("hist_colors_groupbox"))
        self.horizontalLayout_4 = QtGui.QHBoxLayout(self.hist_colors_groupbox)
        self.horizontalLayout_4.setObjectName(_fromUtf8("horizontalLayout_4"))
        self.verticalLayout_2 = QtGui.QVBoxLayout()
        self.verticalLayout_2.setObjectName(_fromUtf8("verticalLayout_2"))
        self.no_gradient_radiobtn = QtGui.QRadioButton(self.hist_colors_groupbox)
        ...
        self.gradient_radiobtn = QtGui.QRadioButton(self.hist_colors_groupbox)
        ...
        self.fixed_color_widget = QtGui.QWidget(self.hist_colors_groupbox)
        self.fixed_color_widget.setObjectName(_fromUtf8("fixed_color_widget"))
        self.fixed_color_layout = QtGui.QHBoxLayout(self.fixed_color_widget)
        self.fixed_color_layout.setMargin(0)
        self.fixed_color_layout.setObjectName(_fromUtf8("fixed_color_layout"))
        self.label_6 = QtGui.QLabel(self.fixed_color_widget)
        self.label_6.setObjectName(_fromUtf8("label_6"))
        self.fixed_color_layout.addWidget(self.label_6)
        self.fill_color_btn = QtGui.QPushButton(self.fixed_color_widget)
...
"background-color: rgb(255, 255, 255);"))
        ...
        self.outline_color_btn = QtGui.QPushButton(self.fixed_color_widget)
...
"background-color: rgb(0, 0, 0);"))
        ...
        self.verticalLayout.addWidget(self.fixed_color_widget)
        self.gradient_widget = QtGui.QWidget(self.hist_colors_groupbox)
        self.gradient_widget.setObjectName(_fromUtf8("gradient_widget"))
        self.gradient_layout = QtGui.QVBoxLayout(self.gradient_widget)
        self.gradient_layout.setMargin(0)
        self.gradient_layout.setObjectName(_fromUtf8("gradient_layout"))
        self.horizontalLayout_6 = QtGui.QHBoxLayout()
        self.horizontalLayout_6.setObjectName(_fromUtf8("horizontalLayout_6"))
        self.label_13 = QtGui.QLabel(self.gradient_widget)
        self.label_13.setObjectName(_fromUtf8("label_13"))
        self.horizontalLayout_6.addWidget(self.label_13)
        self.low_color_change_btn = QtGui.QPushButton(self.gradient_widget)
        ...
        self.high_color_change_btn = QtGui.QPushButton(self.gradient_widget)
        ...
        self.label_14 = QtGui.QLabel(self.gradient_widget)
        self.label_14.setObjectName(_fromUtf8("label_14"))
        self.horizontalLayout_10.addWidget(self.label_14)
        self.count_le = QtGui.QLineEdit(self.gradient_widget)
        ...
        self.verticalLayout.addWidget(self.gradient_widget)
        self.horizontalLayout_4.addLayout(self.verticalLayout)
        self.verticalLayout_3.addWidget(self.hist_colors_groupbox)
    ...
    def retranslateUi(self, WizardPage):
        ...
        self.hist_colors_groupbox.setTitle(_translate("WizardPage", "Histogram Bar Colors", None))
